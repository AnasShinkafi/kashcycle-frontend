...
export default function page() {
  ...
  return (
    <>
      ...
      <Heading textAlign='left' fontSize={{base:'20px', md:'32px'}} mt={30} color='teal'>Pick a Number</Heading>
      <Card align='center' mx={20} w={{base:'90%', md:'60%'}} mt={0} bg='teal.500'>
        <CardHeader>
          <Heading textAlign='left' fontSize={{base:'16px', md:'24px'}} color='white'>Do you prefer a particular number for your collection?</Heading>
        </CardHeader>
        <CardBody>
        <InputGroup gap={4}>
            ...
            <Text textAlign='center' color='white' fontSize={26}>No!</Text>
        </CardBody>
        <CardFooter>
