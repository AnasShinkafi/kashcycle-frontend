  ...
  return (
    <>
      <Box w='100%' bg='gray.300' h={'max-content'} >
        ...
        <Heading as='h3' textAlign='center' pt={6}>Privacy & Policy</Heading>
            <Box bg='teal' mx={{base:6, md:10}} roundedTop={40} h={'max-content'} pb={10} mt={10}>
              <Text fontSize={25} fontWeight='bold' textAlign='center' mx={4} pt={6}>Application of Privacy and Policy</Text>
